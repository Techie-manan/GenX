                ...
                <div className='centre flex-col gap-15 px-[5vw]'>
                    <FadeUp>
                        <div className='text-center sm:w-2/3 justify-self-center p-2 md:p-8 pb-20 lg:w-1/2 rounded-2xl shadow-lg shadow-gray-500 '>
                            ...
                            <p>HackComet 1.0 is more than a hackathon—it’s a tech carnival by CodeX x Genesis uniting top student innovators and coders worldwide. Launching at SRMIST Delhi-NCR and culminating at Google Office, Gurugram, it runs from 12th September to 12th October 2025. Expect thrilling workshops, expert talks, and a 24-hour on-site hackathon. With elite mentorship and global exposure, HackComet 1.0 is where bold ideas transform into real solutions and the future of tech takes center stage.</p>
                        </div>
                    </FadeUp>
